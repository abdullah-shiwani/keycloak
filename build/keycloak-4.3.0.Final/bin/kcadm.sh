...
#else
#    java $KC_OPTS -cp $DIRNAME/client/keycloak-admin-cli-4.3.0.Final-SNAPSHOT.jar org.keycloak.client.admin.cli.KcAdmMain "$@" --noconfig --token $(kcinit token admin-cli) --server $(kcinit show server)
#fi
